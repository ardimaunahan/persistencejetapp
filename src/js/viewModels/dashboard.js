    ...
    function DashboardViewModel() {
        ...
        persistenceManager.init().then(function () {
            ...
            .then(function (registration) {
                // Need to create a custom jsonProcessor and queryHandler
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                for (var i = 0; i < data.length; i++) {
                    self.allItems.push({"id": data[i].EmployeeId, "item": data[i].FirstName});
                }
        ...
        self.searchData = function (event) {
            var searchUrl = "http://localhost:3000/employees?q=FirstName='" + self.searchName() + "'";
